...
append_js $sc_web_path/templates/components.html components/js/set_identity/set_identity.js
append_css $sc_web_path/templates/components.html components/css/set_identity.css
